...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--xptar-abs-max", type=float, default=0.07, help="Maximum absolute P_gtr_th for physics selection")
    parser.add_argument("--yptar-abs-max", type=float, default=0.04, help="Maximum absolute P_gtr_ph for physics selection")
